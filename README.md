...
```json
{
    ...
    "data": {
        ...
        "opencode": "OPENCODE_DISABLE_CLAUDE_CODE=true OPENCODE_DISABLE_EXTERNAL_SKILLS=true IS_SANDBOX=1 opencode $([ -n \"$(opencode session list --format json --max-count 1 2>/dev/null)\" ] && echo --continue) --auto --model opencode-go/glm-5.2\r",
