...
```json
{
    ...
    "data": {
        ...
        "codex": "codex resume --last --include-non-interactive --yolo --model gpt-5.6-sol -c model_reasoning_effort=\"high\"\r",
