...
```json
{
    ...
    "data": {
        ...
        "ai": "Prüfe bitte die letzten Codeänderungen noch einmal sehr gründlich darauf, ob alles konsistent und vollständig umgesetzt wurde, ob dabei etwas übersehen, vergessen oder unbeabsichtigt verändert wurde und ob es irgendwo noch logische, funktionale oder strukturelle Probleme gibt.",
