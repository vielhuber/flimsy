...
```json
{
    ...
    "data": {
        ...
        "gitp": "git add -A . && git commit -m \".\" && git push origin master",
        "gitp $a": "git add -A . && git commit -m \"$a\" && git push origin master",
        "gitt $a $b": "git add -A . && git commit -m \"$a\" && git push origin master && git tag -a \"$b\" -m \"$a\" && git push --tags",
        "iconc": "©",
        "iconr": "®",
